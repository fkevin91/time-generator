...
const label_total_1 = ref("Total HT")
const label_total_2 = ref("")
const label_total_3 = ref("Net à payer")
const label_total_4 = ref("TVA non Applicable article 293B du CGI")
const total_1 = ref("")
const total_2 = ref("")
const total_3 = ref("")
const text_bottom_left_1 = ref("Conditions de règlement :")
const text_bottom_left_2 = ref("30% au démarrage chantier -Acomptes selon avancement des travaux")
const text_bottom_left_3 = ref("« Bon pour accord et commande »")
const sign_1 = ref("Pour l'entreprise")
const sign_2 = ref("Pour le client ")
const useTVA = ref(false)
...
<template>
  <div class="space-y-2 ">
    ...
    <div class="grid grid-cols-6 gap-2 text-xs opacity-90 bg-white p-3">
      ...
      <div class="bg-blue-400">
        <input type="text" class="w-full p-1" v-model="total_1">
      </div>
      <div class="bg-green-400 col-span-4">
      ...
      <div class="bg-blue-400">
        <input type="text" class="w-full p-1" v-model="total_3">
      </div>
      <div class="bg-blue-400 col-span-2">
        <input type="text" class="w-full p-1" v-model="sign_1">
      </div>
      <div class="bg-white col-span-2">
        <input type="text" class="w-full p-1" v-model="sign_2">
      </div>
